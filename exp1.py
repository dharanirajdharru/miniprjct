        ...
        for iface in ifaces:
            ...
            try:
                ...
                for network in networks[1:]:
                    ...
                    if(dBm<=0 and dBm >= -50):
                        sg = "strong"
                    elif(dBm >= -90 and dBm < -50):
                        sg = "medium"
                    elif(dBm < -90 and dBm > -110):
                        sg = "low"
                    print("Router{}: {}".format(i,network.dot11Ssid.SSID[:network.dot11Ssid.SSIDLength].decode()))
                    print("         Signal Strength: {:2d}dBm({})".format(dBm,sg))
                    i+=1
